...
export REPO_PATH=/home/sustage/Codes/epos/repository  # Folder for the EPOS repository.
export STORE_PATH=/home/sustage/Codes/epos/store  # Folder for TFRecord files and trained models.
export BOP_PATH=/home/sustage/Codes/epos/datasets  # Folder for BOP datasets (bop.felk.cvut.cz/datasets).
